...
public class CampainPanel : MonoBehaviour {
	...
	void LoadLevel1(){
		...
		controller.SendMessage("HidePanel" , ScreenManager.PN_CAMPAIN_MAP);
		controller.SendMessage("ShowPanel" , ScreenManager.PN_CAMPAIN_ONGAME);
